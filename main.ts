...
scene.onHitWall(SpriteKind.Player, function (sprite, location) {
    if (sprite.isHittingTile(CollisionDirection.Bottom)) {
        numberOfJumps = 0
        if (tiles.tileAtLocationEquals(tiles.getTileLocation(location.column, location.row), sprites.dungeon.hazardLava1)) {
            info.changeLifeBy(-1)
            Jump()
...
scene.onHitWall(SpriteKind.Enemy, function (sprite, location) {
    if (sprite.isHittingTile(CollisionDirection.Left)) {
        ...
        if (sprite.isHittingTile(CollisionDirection.Bottom) && tiles.tileAtLocationEquals(tiles.getTileLocation(location.column, location.row), sprites.dungeon.hazardLava0)) {
...
function spawnEnemy (col: number, row: number) {
    mySprite = sprites.create(img`
        ........................
        ........................
        ........................
